...
/*==============USER-INFO==============*/
global.owner = [
  ['923147479898', 'QADEER ᴏꜰꜰɪᴄɪᴀʟ', true], 
  ['put your number', 'your-name', true] 
] 

global.mods = ['put-your-number','923147479898'] //Don't replace this,If you want to add someone add any dev
global.prems = ['put-premium-user-number','']
global.nomorbot = 'your-bot-number' //Change it to your own
global.nomorown = 'owner-number' 'QADEER SAM'//Change it to your own
global.namebot = 'bot-name' ' MR QADEER OFFICIAL '//change it to your own
